...
var myProfileWrapper = document.querySelector('.profile-wrapper');
var editProfileWrapper = document.querySelector('.edit-profile-wrapper');
var editProfileInput = document.querySelectorAll('.edit-profile-wrapper .personal-info input');
var editProfileBtn = document.querySelector('.edit-profile-btn');
var saveChangesBtn = document.querySelector('.save-profile-btn');
editProfileBtn.addEventListener('click', function () {
  myProfileWrapper.classList.add('hide');
  editProfileWrapper.classList.add('show');
});
editProfileWrapper.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
    var firstName, lastName, response, result;
